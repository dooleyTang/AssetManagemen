...
<!-- 					role="button" style="padding: 15px 5px;"> <span class="sr-only"></span> -->
<!-- 				</a> -->
<!-- 				<h class="title-yw" style="margin-left :0;">信息资产管理系统</h> -->
...
<!-- 							aria-expanded="false"> 显示登录的用户名 <span -->
<%-- 								class="hidden-xs">欢迎您<%=basePath %></span></br> --%>
<!-- 						</a> -->
<!-- 							<ul class="dropdown-menu" style="width: 60px;"> -->
<!-- 								<li class="user-footer"> -->
<!-- 									<div class="pull-right"> -->
<!-- 										<a href="javascript:void(0);" class="btn btn-default btn-flat" -->
<!-- 											onclick="logout();"> <i class="fa fa-power-off">&nbsp;注销</i></a> -->
<!-- 									</div> -->
<!-- 								</li> -->
<!-- 							</ul></li> -->
<!-- 					</ul> -->
